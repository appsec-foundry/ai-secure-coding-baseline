...
assistant behaves. Read `specs/README.md` before changing the baseline, a test
case, or the workflow — it describes how changes run here.
...
The secure-coding baseline below is generated from `secure-coding-baseline.md`.
Do not edit it here; run `make sync-agents` after changing the normative file.
