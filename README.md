...
curl --proto '=https' \
  ...
  https://raw.githubusercontent.com/appsec-foundry/aiscb/29bdc5a3f7fc5a3e8189100a124ca510bd9a62ab/setup.sh &&
echo 'd4b2abf71d83ce3175017c44970497b54c20f83f823beb2c3728825bc8e770f3  aiscb-setup.sh' |
  sha256sum --check &&
bash aiscb-setup.sh
```
