...
[![PRs welcome](https://img.shields.io/badge/PRs-welcome-brightgreen.svg)](https://github.com/matthiasrohr/ai-secure-coding-baseline/pulls)
...
The baseline is deliberately compact: ~8.6 KB (roughly 2,200 model tokens), including one condensed rule for LLM-powered features. Counts vary by tokenizer. The wording has been reviewed and refined through AI-assisted coding tasks—practical testing, not a formal security certification.
