...
curl --proto '=https' \
  ...
  https://raw.githubusercontent.com/appsec-foundry/aiscb/03f204ad8efb01ef98a5e73e06bc7057134fd83f/setup.sh &&
echo 'd52ad36042d00e6957a8b5987db5763d237629108087f8ee35aa0aa244dd52cf  aiscb-setup.sh' |
  sha256sum --check &&
bash aiscb-setup.sh
```
...
`secure-coding-baseline.md` is the normative product. At 20.4 KB, or 4,065 tokens, it stays within its approximate 4,100-token budget. It has been shaped through practical AI-assisted coding tasks but has not undergone formal certification.
