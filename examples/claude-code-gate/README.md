...
| --- | --- |
| `AISEC-PRESERVE-001` | Disabling TLS certificate verification, for example `verify=False` or `curl -k` |
| `AISEC-PRESERVE-001` | Adding a switch that disables authentication, authorization, or CSRF protection |
